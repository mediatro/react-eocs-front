...
import {AvailableCurrencies, CurrencyType, PaymentManagerContext, PaymentType} from "../services/PaymentProvider";
            ...
            <Paper>
                <Box p={1} m={1}>
                    {pmc.manager.isPaymentDetailsBlocked() ? <>
                        <Typography>
                            <FormattedMessage id={'payment.text.payment_details.blocked'}/><br/>
